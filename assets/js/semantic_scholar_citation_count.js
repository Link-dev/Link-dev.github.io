    ...
    semanticScholarIds.forEach(id => {
        ...
        if (cachedData) {
            ...
            elements.forEach(element => {
                element.innerHTML = `<a class="badge badge-citations" href="https://www.semanticscholar.org/paper/${id}" target="_blank"><i class="ai ai-semantic-scholar"></i> ${parseInt(citationCount).toLocaleString()} citations</a>`;
            });
        }
    });
};
